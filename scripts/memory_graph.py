...
from selene.memories.memory_reference_analysis import iter_referenced_names_in_content


def main() -> None:
    parser = argparse.ArgumentParser(description="Generate a GraphML graph of memory references for a Selene project.")
    ...
    project = selene_config.get_project(args.project)
    if project is None:
        raise SystemExit(f"Project '{args.project}' not found in Selene configuration.")
