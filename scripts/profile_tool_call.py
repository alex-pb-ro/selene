...
from selene.tools import FindSymbolTool
...
if __name__ == "__main__":
    ...
    project_path = Path(__file__).parent.parent  # Selene root

    selene_config = SeleneConfig.from_config_file()
    selene_config.log_level = logging.INFO
    selene_config.gui_log_window = False
    selene_config.web_dashboard = False

    agent = SeleneAgent(str(project_path), selene_config=selene_config)
