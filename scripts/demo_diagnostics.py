"""
Demonstrates diagnostics tools and edit-tool diagnostic reporting on the Selene repo itself.
...
def make_agent() -> SeleneAgent:
    """Create an LSP-backed Selene agent for the Selene repository."""
    ...
    return SeleneAgent(project="demo_selene_repo", selene_config=selene_config)
...
if __name__ == "__main__":
    ...
    temp_dir = Path(tempfile.mkdtemp(prefix="selene_demo_", dir=REPO_PATH))
