...
from selene.constants import PROMPT_TEMPLATES_DIR_INTERNAL, REPO_ROOT
...
def main():
    autogenerate_prompt_factory_module(
        ...
        target_module_path=str(Path(REPO_ROOT) / "src" / "selene" / "generated" / "generated_prompt_factory.py"),
    )
