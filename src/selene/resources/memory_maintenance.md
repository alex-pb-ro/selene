...
- Renaming memories: References are updated automatically if handled via Selene's memory rename tool.
- Checking for stale memories (e.g. after deletion): Call `selene memories check` for a report.
