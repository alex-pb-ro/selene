...
:class:`selene.project.MemoriesManager` to (a) detect and rank references
...
``selene_repository_structure`` but their token Jaccard is only 1/3, so we reject it at
this floor."""
