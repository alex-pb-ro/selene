...
from selene.code_editor import JetBrainsCodeEditor
from selene.jetbrains.jetbrains_plugin_client import JetBrainsPluginClient
from selene.jetbrains.jetbrains_types import SymbolDTO, SymbolDTOUtil
from selene.symbol import JetBrainsSymbolDictGrouper
from selene.tools import Tool, ToolMarkerBeta, ToolMarkerOptional, ToolMarkerSymbolicEdit, ToolMarkerSymbolicRead
from selene.util.text_utils import find_text_coordinates
...
class JetBrainsDebugTool(Tool, ToolMarkerOptional, ToolMarkerBeta):
    ...
    def apply(
        ...
        Use the `selene_info` tool with topic `jet_brains_debug_repl` for usage information.
