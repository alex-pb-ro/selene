...
from selene.tools import Tool, ToolMarkerDoesNotRequireActiveProject, ToolMarkerOptional, WriteMemoryTool
...
class InitialInstructionsTool(Tool, ToolMarkerDoesNotRequireActiveProject):
    """
    Provides instructions Selene usage (i.e. the 'Selene Instructions Manual')
    ...
    def apply(self, session_id: str) -> str:
        """
        Provides the 'Selene Instructions Manual', which contains essential information on how to use the Selene toolbox.
...
class SeleneInfoTool(Tool, ToolMarkerOptional, ToolMarkerDoesNotRequireActiveProject):
    """
    ...
    def apply(self, topic: str) -> str:
        """
        Retrieves Selene-specific information
