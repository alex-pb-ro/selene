...
class LanguageServerSymbolLocation:
    """
    Represents the (start) location of a symbol identifier, which, within Selene, uniquely identifies the symbol.
    """
...
class LanguageServerSymbolRetriever:
    ...
    def _get_symbol_info_budget(self) -> float:
        symbol_info_budget = self.project.selene_config.symbol_info_budget
