    ...
    def run_gui(self):
        ...
        try:
            ...
            if sys.platform == "win32":
                ...
                ctypes.windll.shell32.SetCurrentProcessExplicitAppUserModelID("local.selene")
            ...
            dashboard_path = Path(constants.SELENE_DASHBOARD_DIR)

            # Load and display the logo image
            try:
                # construct path relative to path of this file
                image_path = dashboard_path / "selene-logs.png"
            ...
            # Configure icons
            icon_16 = tk.PhotoImage(file=dashboard_path / "selene-icon-16.png")
            icon_32 = tk.PhotoImage(file=dashboard_path / "selene-icon-32.png")
            icon_48 = tk.PhotoImage(file=dashboard_path / "selene-icon-48.png")
