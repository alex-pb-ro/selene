            ...
            for change in workspace_edit["documentChanges"]:
                if "textDocument" in change and "edits" in change:
                    ...
                    if change["kind"] == "rename":
                        ...
                        raise ValueError(f"Unhandled document change kind: {change}; Please report to Selene developers.")
                else:
                    raise ValueError(f"Unhandled document change format: {change}; Please report to Selene developers.")
