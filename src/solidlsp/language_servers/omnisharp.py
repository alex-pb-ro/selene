...
class OmniSharp(SolidLanguageServer):
    ...
    You can pass the following entries in ``ls_specific_settings["csharp_omnisharp"]``:
        - omnisharp_version: Override the pinned OmniSharp version downloaded by Selene.
        - razor_omnisharp_version: Override the pinned Razor plugin version downloaded by Selene.
    """
