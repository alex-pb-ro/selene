...
class HaxeLanguageServer(SolidLanguageServer):
        ...
        def _get_or_install_core_dependency(self) -> str:
            ...
            if shutil.which("node") is None:
                raise FileNotFoundError(
                    ...
                    "  3. Set ls_path in selene_config.yml under ls_specific_settings.haxe"
                )
            ...
            raise FileNotFoundError(
                ...
                "  2. Set ls_path in selene_config.yml under ls_specific_settings.haxe"
            )
    ...
    def _discover_hxml_file(repository_absolute_path: str) -> list[str]:
        ...
        For more control, set ``ls_specific_settings.haxe.buildFile`` in ``selene_config.yml``.
        """
        max_depth = 5
            ...
            for f in files:
                if f.endswith(".hxml") and "haxe_libraries" not in root:
                    ...
                    log.info(
                        ...
                        "ls_specific_settings.haxe.buildFile in selene_config.yml.",
                        hxml_path,
                    )
                    return [hxml_path]
