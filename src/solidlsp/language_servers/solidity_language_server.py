...
class SolidityLanguageServer(SolidLanguageServer):
    ...
    state root for the managed Solidity language server. By default, Selene uses
    ...
    class DependencyProvider(LanguageServerDependencyProviderSinglePath):
        ...
        def create_launch_command_env(self) -> dict[str, str]:
            ...
            if platform.system() == "Darwin":
                ...
                launch_env["SELENE_SOLIDITY_STATE_DIR"] = state_dir
    ...
    def _create_base_initialize_params(self) -> dict:
        ...
        return {
            ...
            "initializationOptions": {"telemetryEnabled": False},
        }
