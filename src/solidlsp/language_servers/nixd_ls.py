...
class NixLanguageServer(SolidLanguageServer):
    ...
    class DependencyProvider(LanguageServerDependencyProviderSinglePath):
        ...
        def _get_nixd_path() -> str | None:
            ...
            possible_paths = [
                home / ".local" / "bin" / "nixd",
                home / ".selene" / "language_servers" / "nixd" / "nixd",
            ...
            if platform.system() == "Windows":
                possible_paths.extend(
                    [
                        ...
                        home / ".selene" / "language_servers" / "nixd" / "nixd.exe",
                    ]
                )
    ...
    def _extend_nix_symbol_range_to_include_semicolon(
        ...
        nixd provides ranges that exclude semicolons (expression-level), but selene needs
    ...
    def _build_document_symbols_from_raw_symbols(self, relative_file_path: str, file_buffer: LSPFileBuffer) -> DocumentSymbols:
        ...
        # nixd provides expression-level ranges (excluding semicolons) but selene needs
