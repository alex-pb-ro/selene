...
class JsonLanguageServer(SolidLanguageServer):
    ...
    def _create_base_initialize_params(self) -> dict:
        ...
        initialize_params = {
            "locale": "en",
            # Delegate remote schemas to the client, where they are explicitly refused below.
            "initializationOptions": {"handledSchemaProtocols": ["file"]},
            "capabilities": {
                "textDocument": {
    ...
    def _start_server(self) -> None:
        ...
        def reject_remote_schema(uri: str) -> None:
            raise ValueError("Remote JSON schema fetching is disabled in Selene")
