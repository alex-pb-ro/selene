...
class UnifiedSymbolInformation(TypedDict):
    ...
    with added fields for SolidLSP/Selene use.
    """
    ...
    Note: within Selene, the parent attribute was added and should be used instead.
    ...
    """The parent of the symbol, if there is any. Added with Selene, not part of the LSP.
    ...
    Added for Selene, not part of the LSP.
    """
