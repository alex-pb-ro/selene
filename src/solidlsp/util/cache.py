...
def load_cached_values(path: str) -> Any:
    """Load symbol cache values without allowing arbitrary deserialisation code."""
    from solidlsp.ls import DocumentSymbols, SymbolBody
    from solidlsp.lsp_protocol_handler.lsp_types import SymbolKind, SymbolTag

    return DataOnlyUnpickler.load_file(path, (DocumentSymbols, SymbolBody, SymbolKind, SymbolTag))
