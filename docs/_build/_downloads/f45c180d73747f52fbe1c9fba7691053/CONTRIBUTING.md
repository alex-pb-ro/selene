...
Thank you for your interest in contributing to Selene!

## Scope of Contributions

The following types of contributions can be submitted directly via pull requests:
  * isolated additions which do not change the behaviour of Selene and only extend it along existing lines (e.g., adding support for a new language server)
  * small bug fixes
...
See the corresponding [memory](.selene/memories/adding_new_language_support_guide.md).
...
To install Selene as a local tool, run
...
The Selene tools (and in fact all Selene code) can be executed without an LLM, and also without
