...
def autogen_tool_list(target_filename = "01-about/035_tools.md"):
    ...
    with open(target_file, "w") as f:
        ...
        f.write("# Tools\n\n")
        f.write("Find the full list of Selene's tools below.\n\n")
...
def autogen_about_intro_features():
    """Generate local overview pages without copying attribution or fetching remote content."""
    about_dir = Path(__file__).parent / "01-about"
    (about_dir / "000_intro.md").write_text(
        "# About Selene\n\n"
        "Selene is a local MCP server for semantic code navigation, editing, and project memories. "
        "It returns tool results to your connected AI client.\n\n"
        "See the [installation guide](../02-usage/010_installation.md) and "
        "{download}`security audit <../../SECURITY_AUDIT.md>`.\n",
        encoding="utf-8",
    )
    (about_dir / "025_features.md").write_text(
        "# Features\n\n"
        "- Symbol search, definitions, references, and diagnostics through language servers.\n"
        "- Symbol-aware editing and refactoring.\n"
        "- Local project memories, contexts, and modes.\n"
        "- A local dashboard with bundled assets and local usage statistics.\n\n"
        "See the [tool reference](035_tools.md) for the available tools.\n",
        encoding="utf-8",
    )
