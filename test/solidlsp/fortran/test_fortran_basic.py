...
These tests validate some low-level LSP functionality and high-level Selene APIs.
...
class TestFortranLanguageServer:
    ...
    def test_request_referencing_symbols(self, language_server: SolidLanguageServer) -> None:
        """Test finding symbols that reference a function - Selene's high-level API.
    ...
    def test_request_defining_symbol(self, language_server: SolidLanguageServer) -> None:
        """Test finding the defining symbol - Selene's high-level API.
