...
- Detection failing means Selene is unusable for Rust, even when rust-analyzer is correctly installed
...
class TestRustAnalyzerDetection:
    ...
    def test_detect_from_nix_path_without_rustup(self):
        ...
        Selene should still detect and use this binary.
        Fixes: historical issue #800
        """
        from solidlsp.language_servers.rust_analyzer import RustAnalyzer
    ...
    def test_error_message_lists_searched_locations_when_not_found(self):
        ...
        WHY: Users need to know WHERE Selene looked so they can fix their installation.
    ...
    def test_auto_install_via_rustup_when_not_found(self):
        ...
        WHY: Selene should auto-install rust-analyzer via rustup when possible.
