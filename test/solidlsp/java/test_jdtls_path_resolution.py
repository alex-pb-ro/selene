...
class TestComputeWorkspaceHash:
    ...
    DEFAULT_LAUNCHER = "/srv/selene/static/eclipse-jdtls-1.49.0/plugins/org.eclipse.equinox.launcher_1.7.100.jar"
...
class TestIsIgnoredDirname:
    ...
    @pytest.mark.parametrize("dirname", [".git", ".venv", ".idea", ".selene", ".mypy_cache"])
