...
from selene.constants import DEFAULT_SOURCE_FILE_ENCODING
from selene.project import Project
from selene.tools import ReadFileTool
from solidlsp.ls_utils import TextUtils


@pytest.fixture
def read_file_tool(tmp_path: Path) -> ReadFileTool:
    project = Project.load(str(tmp_path), selene_config=SeleneConfig(gui_log_window=False, web_dashboard=False))
    agent = MagicMock()
