...
from selene.util.text_utils import GlobMatcher, LineType, MultiFileContentReplacer, search_files, search_text
...
class TestSearchFiles:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ["src/selene/agent.py", "src/selene/process_isolated_agent.py", "test/agent.py"],
                "match",
                "src/**agent.py",
                None,
                ["src/selene/agent.py", "src/selene/process_isolated_agent.py"],
                "Glob: src/**agent.py should match files ending with agent.py under src/",
            ),
            (
                ["src/selene/agent.py", "src/selene/process_isolated_agent.py", "other/agent.py"],
                "match",
                "**agent.py",
                None,
                ["src/selene/agent.py", "src/selene/process_isolated_agent.py", "other/agent.py"],
            ...
            (
                ["agent.py", "src/agent.py", "src/selene/agent.py"],
                "match",
                "**agent.py",
                None,
                ["agent.py", "src/agent.py", "src/selene/agent.py"],
...
class TestGlobMatch:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("**agent.py", "agent.py", True),
            ("**/agent.py", "agent.py", True),
            ("**/agent.py", "src/selene/agent.py", True),
            ("src/**/agent.py", "src/agent.py", True),
            ("src/**/agent.py", "src/selene/foo/agent.py", True),
            ("src/s**e/agent.py", "src/selene/agent.py", True),
            ("src/s**a/agent.py", "src/selene/a/agent.py", True),
            ("**agent.py", "src/agent.py", True),
            ("**agent.py", "src/selene/agent.py", True),
            ("**agent.py", "src/selene/process_isolated_agent.py", True),
            ("**agent.py", "agent_test.py", False),
            ("src/**agent.py", "src/agent.py", True),
            ("src/**agent.py", "src/selene/agent.py", True),
            ("src/**agent.py", "src/selene/process_isolated_agent.py", True),
