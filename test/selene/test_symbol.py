...
from selene.jetbrains.jetbrains_types import SymbolDTO, SymbolDTOKey
from selene.project import Project
from selene.symbol import LanguageServerSymbol, LanguageServerSymbolRetriever, NamePathComponent, NamePathMatcher
...
class TestHoverBudget:
    ...
    def test_budget_not_exceeded_all_lookups_performed(self, project_with_ls: Project, monkeypatch: pytest.MonkeyPatch):
        ...
        project_with_ls.selene_config.symbol_info_budget = 10.0
    ...
    def test_budget_exceeded_partial_info(self, project_with_ls: Project, monkeypatch: pytest.MonkeyPatch):
        ...
        project_with_ls.selene_config.symbol_info_budget = 0.1
        ...
        monkeypatch.setattr("selene.symbol.perf_counter", mock_perf_counter)
    ...
    def test_budget_zero_means_unlimited(self, project_with_ls: Project, monkeypatch: pytest.MonkeyPatch):
        ...
        project_with_ls.selene_config.symbol_info_budget = 0.0
