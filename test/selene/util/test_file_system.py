...
from selene.util.file_system import GitignoreParser, GitignoreSpec, _escape_gitignore_path_component, match_path, write_file_atomic
...
class TestGitignoreParserPermissionError:
    ...
    def test_scandir_permission_error_on_subdirectory(self):
        ...
        Regression test for historical issue #1624
        """
