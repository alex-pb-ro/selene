"""Tests for SeleneAgent._run_activation_command."""
...
class TestRunActivationCommand:
    """Unit tests for SeleneAgent._run_activation_command."""

    def _make_agent(self, project: Project):
        from selene.agent import SeleneAgent

        agent = SeleneAgent.__new__(SeleneAgent)
        # wire up only what _run_activation_command needs
        agent.selene_config = project.selene_config
        return agent
