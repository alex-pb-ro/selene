...
def _make_dashboard(project_languages: list[LanguageServerId] | None) -> SeleneDashboardAPI:
    project = None
    ...
    return SeleneDashboardAPI(memory_log_handler=_DummyMemoryLogHandler(), tool_names=[], agent=agent, tool_usage_stats=None)
