...
from selene.project_server import ProjectServer, QueryProjectRequest
...
def test_cached_project_lookup_is_not_blocked_by_unrelated_cold_load(project_server: ProjectServer) -> None:
    ...
    selene_config = cast(Any, project_server._agent.selene_config)
    selene_config.get_registered_project.side_effect = {
...
def test_concurrent_lookups_load_each_project_only_once(project_server: ProjectServer) -> None:
    ...
    selene_config.get_registered_project.side_effect = get_registration
    ...
    registration.get_project_instance.assert_called_once_with(selene_config)
